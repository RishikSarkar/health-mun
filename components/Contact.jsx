                ...
                <form action='https://getform.io/f/f3e777d7-a5fd-42fd-8561-682d83f8c51d' method='POST' encType='multipart/form-data' onSubmit={handleFormSubmission}>
                    <div className='grid grid-cols-2 gap-4 py-2'>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <input className='text-black dark:text-white bg-white dark:bg-black/40 border-2 py-1 px-2 flex' name='First_Name' type="text" style={{ outline: 'none' }} />
                        </div>

                        <div className='flex flex-col'>
                            <label className='uppercase text-sm py-2 select-none'>Last Name</label>
                            <input className='text-black dark:text-white bg-white dark:bg-black/40 border-2 py-1 px-2 flex' name='Last_Name' type="text" style={{ outline: 'none' }} />
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col py-2'>
                        ...
                        <textarea className='text-black dark:text-white bg-white dark:bg-black/40 border-2 py-1 px-2' name='Message' type="text" rows='3' style={{ resize: 'none', outline: 'none' }} required></textarea>
                    </div>
