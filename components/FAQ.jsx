    ...
    return (
        <div id='faq' className='font-marcellus w-full h-auto pb-2 text-center bg-gradient-to-b from-[#1EA497] to-[#16796F] dark:bg-gradient-to-b dark:from-[#1a2726] dark:to-[#041312] overflow-x-hidden'>
            ...
            <div className='text-xl font-montserrat p-4 mt-4 mb-12 uppercase flex select-none justify-center items-center'>
                <div className='p-6 bg-[#16796F] text-[#F7FAFA] dark:bg-[#041312] dark:text-[#F7FAFA] hover:bg-[#F7FAFA]/20 dark:hover:bg-[#F7FAFA]/10 border-4 border-white dark:border-[#F7FAFA] cursor-pointer ease-in duration-100'>
                    <Link href='/#contact'>
                        Questions?
                    </Link>
                </div>
